...
function Welcome() {
    ...
    return (
        <section className='text-center flex flex-col gap-4 my-4'>
            ...
            <button className='px-10 sm:px-14 py-1 sm:py-1.5 bg-orange-600 text-white rounded-full w-fit mx-auto font-bold tracking-normal transition-all hover:bg-orange-500' onClick={handleClick}>
               Intens Register 
            </button>
