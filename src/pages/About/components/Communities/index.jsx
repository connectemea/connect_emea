    ...
    <div className='flex flex-col'>
      ...
      <section className='flex flex-col sm:flex-row items-center justify-center gap-16 m-10'>
        <div className='flex items-center flex-col'>
          ...
          <div className='flex flex-col items-center justify-start rounded-3xl p-4 border text-center max-w-[420px] md:max-w-[320px]  h-full min-h-[300px] border-gray-500 shadow-xl shadow-black/25'>
        ...
        <div className='flex items-center flex-col'>
          ...
          <div className='flex flex-col items-center justify-start rounded-3xl p-4 border text-center max-w-[420px] md:max-w-[320px] h-full min-h-[300px] border-gray-500 shadow-xl shadow-black/2'>
