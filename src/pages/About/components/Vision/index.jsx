...
function Vision() {
  return (
    <div className='flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12 mt-12 p-6 sm:p-8 rounded-3xl'>
      {/* Content Text Column */}
      ...
      <div className='w-full md:w-1/2 flex items-center justify-center shrink-0'>
        <div className="relative p-2 bg-zinc-50 max-w-[280px]">
          <img 
            draggable={false} 
